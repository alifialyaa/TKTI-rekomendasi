      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="<?php echo base_url(); ?>img/skills.png" class="img-fluid" alt="">
          </div>
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                <div class="progress-bar-wrap">
                  ...
                  <div class="progress-bar-target" role="progressbar" style="width: 80%" aria-valuenow="4" aria-valuemin="0" aria-valuemax="5"></div>
                </div>
              </div>

              <p class="font-italic">
                Nilai maturity level adalah 2.64 dan masuk pada level 3, sedangkan target adalah level 4.
              </p>
            </div>
          </div>
        </div>
